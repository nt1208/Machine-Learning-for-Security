...
for j in range(0, num):
    path_ast = "/media/kali/F6FE3773FE372B6F/DeepVulSeeker/data/cwe758/dot/" + str(j)
    time += 1
    if os.listdir(path_ast):
        path_ast = "/media/kali/F6FE3773FE372B6F/DeepVulSeeker/data/cwe758/dot/" + str(j) + '/0-ast.dot'
        print(path_ast)
...
np.save("/media/kali/F6FE3773FE372B6F/DeepVulSeeker/data/ast/cwe758_ast.npy", ast_matrix)
